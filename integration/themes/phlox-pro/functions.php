...
add_action( 'wp_enqueue_scripts', 'ava_menu_phlox_pro_styles', 0 );

add_action( 'elementor/widget/before_render_content', 'ava_menu_remove_phlox_pro_nav_menu_filters' );
add_filter( 'elementor/widget/render_content',        'ava_menu_add_phlox_pro_nav_menu_filters', 10, 2 );
 ...
 * @return void
 */
function ava_menu_phlox_pro_styles() {
	wp_enqueue_style(
		'ava-menu-phlox-pro',
 ...
 */
function ava_menu_remove_phlox_pro_nav_menu_filters( $widget ) {
 ...
 */
function ava_menu_add_phlox_pro_nav_menu_filters( $content, $widget ) {
